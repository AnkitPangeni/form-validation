...
$/               : Matches the end of the string.
    ...
    password.charAt(0).match(/[a-zA-Z]/) &&
    password.charAt(password.length - 1).match(/[0-9]/)
  ) {
...
function checkboxvalidate(){
  ...
  var front = document.getElementById("front").checked;
  var back = document.getElementById("back").checked;
  var design = document.getElementById("design").checked;

  if(front==false && back==false && design==false)
  {
    alert("Please choose your expertise");
    return false;
  }
  else{
